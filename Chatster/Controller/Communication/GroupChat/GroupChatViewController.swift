...
class GroupChatViewController: JSQMessagesViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let groupProfilePicButton: UIButton = {
    ...
    let groupName: UILabel = {
        ...
        let groupName = UILabel(frame: CGRect(x: 30, y: 10, width: 140, height: 15))
        groupName.textAlignment = .left
        groupName.font = UIFont(name: "Gotham Book", size: 14)
        
        return groupName
        
    }()
    
    let groupStatus: UILabel = {
        
        let groupStatus = UILabel(frame: CGRect(x: 30, y: 25, width: 140, height: 15))
        groupStatus.textAlignment = .left
        groupStatus.font = UIFont(name: "Gotham Book", size: 10)
    ...
    func setCustomTitle() {
        ...
        leftBarButtonView.addSubview(groupProfilePicButton)
        leftBarButtonView.addSubview(groupName)
        leftBarButtonView.addSubview(groupStatus)
        ...
        groupProfilePicButton.setImage(UIImage(named: "info"), for: .normal)
        
        groupName.text = "Test Group"
        groupStatus.text = "Welcome!"
        
    }
    
    @objc func infoButtonPressed() {
        
        let groupChatInfoVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "groupChatInfo") as! GroupChatInfoTableViewController
        
        self.navigationController?.pushViewController(groupChatInfoVC, animated: true)
